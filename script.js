// ==========================================
// 1. GESTIÓN DE PANTALLAS (ACCESO DIRECTO)
// ==========================================
...
// Al cargar, ocultamos login y mostramos menú directamente
window.onload = function() {
    if (loginScreen) {
        loginScreen.style.display = 'none'; // Ocultar pantalla de login
    }
    if (mainMenu) {
        mainMenu.classList.remove('hidden'); // Mostrar menú principal
    }
};
...
document.getElementById('btn-mode-rosco').addEventListener('click', () => {
    ...
    // Reiniciar juego al entrar si es necesario, o dejar que den a "Empezar"
});
...
const questionsPool = {
    ...
    F: [
        ...
        { id: 'F', question: "Fruta roja pequeña (parecida a la cereza pero ácida).", answer: "Frambuesa" }, 
    ...
    G: [
        ...
        { id: 'G', question: "Guerra civil española (bando contrario a nacional).", answer: "Gubernamental" }, 
    ...
    M: [
        ...
        { id: 'M', question: "Día de la semana.", answer: "Martes" }, 
...
if(document.getElementById('start-btn')) document.getElementById('start-btn').addEventListener('click', startRoscoGame);
if(document.getElementById('new-game-btn')) document.getElementById('new-game-btn').addEventListener('click', startRoscoGame);
if(document.getElementById('check-btn')) document.getElementById('check-btn').addEventListener('click', checkRoscoAnswer);
if(document.getElementById('pasapalabra-btn')) document.getElementById('pasapalabra-btn').addEventListener('click', doPasapalabra);
